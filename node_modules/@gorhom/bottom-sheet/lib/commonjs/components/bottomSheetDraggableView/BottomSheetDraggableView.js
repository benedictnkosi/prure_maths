...
const BottomSheetDraggableViewComponent = ({
  ...
  } = (0, _hooks.useBottomSheetGestureHandlers)(); // variables
  ...
  const simultaneousHandlers = (0, _react.useMemo)(() => {
    ...
    return refs;
  }, [_providedSimultaneousHandlers, nativeGestureRef, refreshControlGestureRef]); // styles

  const containerStyle = (0, _react.useMemo)(() => {
    if (!style) {
      return _styles.styles.container;
    }

    if (Array.isArray(style)) {
      return [_styles.styles.container, ...style];
    }
