...
export const useKeyboard = () => {
  ...
  useEffect(() => {
    ...
    return () => {
      Keyboard.removeListener(KEYBOARD_EVENT_MAPPER.KEYBOARD_SHOW, handleOnKeyboardShow);
      Keyboard.removeListener(KEYBOARD_EVENT_MAPPER.KEYBOARD_HIDE, handleOnKeyboardHide);
    };
  }, [handleKeyboardEvent]);
  /**
