...
const BottomSheetModalComponent = /*#__PURE__*/(0, _react.forwardRef)(function BottomSheetModal(props, ref) {
  ...
  const key = (0, _react.useMemo)(() => name || `bottom-sheet-modal-${(0, _nonSecure.nanoid)()}`, [name]); //#endregion
  ...
  const handlePresent = (0, _react.useCallback)(function handlePresent() {
    requestAnimationFrame(() => {
      if (mount) {
        var _bottomSheetRef$curre7;

        (_bottomSheetRef$curre7 = bottomSheetRef.current) === null || _bottomSheetRef$curre7 === void 0 ? void 0 : _bottomSheetRef$curre7.snapToIndex(index);
        return;
      }
  ...
  const handleDismiss = (0, _react.useCallback)(function handleDismiss(animationConfigs) {
    ...
    (_bottomSheetRef$curre8 = bottomSheetRef.current) === null || _bottomSheetRef$curre8 === void 0 ? void 0 : _bottomSheetRef$curre8.forceClose(animationConfigs);
  ...
  const handleRestore = (0, _react.useCallback)(function handleRestore() {
    ...
    minimized.current = false;
    (_bottomSheetRef$curre10 = bottomSheetRef.current) === null || _bottomSheetRef$curre10 === void 0 ? void 0 : _bottomSheetRef$curre10.snapToIndex(restoreIndexRef.current);
  }, []); //#endregion
  //#region callbacks

  const handlePortalOnUnmount = (0, _react.useCallback)(function handlePortalOnUnmount() {
    var _bottomSheetRef$curre11;
    ...
    willUnmountSheet(key);
    (_bottomSheetRef$curre11 = bottomSheetRef.current) === null || _bottomSheetRef$curre11 === void 0 ? void 0 : _bottomSheetRef$curre11.close();
