...
const BottomSheetComponent = /*#__PURE__*/(0, _react.forwardRef)(function BottomSheet(props, ref) {
  ...
  const animatedSnapPoints = (0, _hooks.useNormalizedSnapPoints)(_providedSnapPoints, animatedContainerHeight, topInset, bottomInset, $modal);
  ...
  const animatedNextPosition = (0, _reactNativeReanimated.useSharedValue)(0);
  ...
  const getKeyboardHeightInContainer = (0, _reactNativeReanimated.useWorkletCallback)(() => {
    /**
  ...
  const animatedContentHeight = (0, _reactNativeReanimated.useDerivedValue)(() => {
    const keyboardHeightInContainer = getKeyboardHeightInContainer();
  ...
  const handleSnapToPosition = (0, _reactNativeReanimated.useWorkletCallback)(function handleSnapToPosition(position, animationConfigs) {
    ...
    const nextPosition = (0, _utilities.normalizeSnapPoint)(position, animatedContainerHeight.value, topInset, bottomInset);
    /**
     * exit method if :
     * - layout is not calculated.
     * - already animating to next position.
  ...
  (0, _reactNativeReanimated.useAnimatedReaction)(() => animatedKeyboardState.value, (_keyboardState, _previousKeyboardState) => {
  ...
  }, typeof children === 'function' ? children() : children, footerComponent && /*#__PURE__*/_react.default.createElement(_BottomSheetFooterContainer.default, {
